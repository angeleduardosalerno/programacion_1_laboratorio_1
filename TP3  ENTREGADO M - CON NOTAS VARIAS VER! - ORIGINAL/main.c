...
int main()
{
    ...
    LinkedList* listaEmpleados = ll_newLinkedList(); // CREA UNA NUEVA LISTA LINKED LIST...

    do
    {
        system("cls");
        option = menu(); // HACE EL MENU, DEVUELVE LA OPCION Y CON LA OPCION ENTRA EN EL SWITCH...
        ...
        case 2:
            ...
            flag = 2;                                              // LOS ARCHIVOS BINARIOS NO PUEDEN SER CSV, TIENEN Q SER O .DAT O .BIN.......
            break;
