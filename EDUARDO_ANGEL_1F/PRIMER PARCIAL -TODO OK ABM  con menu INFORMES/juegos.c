...
int printPromedioImporteTotales(Juegos arrayJuegos [], int longitudArray)
{
    ...
    if (arrayJuegos!= NULL && longitudArray > 0)
    {
        for (i=0; i< longitudArray ; i++) // PARA CALCULAR PROMEDIOS Y TOTAL DE SALARIOS.
        {
            ...
            {
                acumuladorImportes= acumuladorImportes + arrayJuegos[i].importeJuego;
                contadorImportes++;
                importePromedio= acumuladorImportes / contadorImportes;
            }
        }

        printf( "\n El total de los IMPORTES es: %0.2f \n El promedio de los IMPORTES es: %0.2f \n\n"
...
{
    int i, contadorImportes=0, contadorImportesMin=0;
    float importePromedio, acumuladorImportes=0;
    int retorno=-1;
    ...
    if (arrayJuegos!= NULL && longitudArray > 0)
    {
        ...
        for (i=0; i< longitudArray ; i++) // PARA CALCULAR LA CANT CON IMPORTES INFERIOR AL PROMEDIO
        {
        ...
        printf( "\n La cantidad de JUEGOS que NO SUPERAN el IMPORTE promedio son: %d \n", contadorImportesMin);
        retorno=0;
