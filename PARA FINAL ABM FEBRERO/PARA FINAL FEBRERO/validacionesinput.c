...
/** \brief Verifica si el valor recibido es Alfanumerico (con al menos 1 letra y  un numero).
 * \param char cadena de caracteres a ser analizada.
 ...
 */
 ...
 {
     int i=0, retorno, contadorLetras=0, contadorNumeros=0;
    ...
    if ((contadorLetras >= 1) && (contadorNumeros >= 1) && (retorno != 0))
        retorno=1;
    else
        retorno=0;
