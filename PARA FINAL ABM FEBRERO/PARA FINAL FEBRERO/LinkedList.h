...
{
    void* pElement;
    //ESTE ES EL DATO DEL NODO, QUE COMO PUEDE SER DE CUALQUIER TIPO INT CHAR ETC, LO CREARON VOID...GUARDA LA DIR DE MEMORIA DE DONDE ESTAN GUARDADOS LOS DATOS DE EMPLOYEE!*******************************
    struct Node* pNextNode; // NODO SIGUIENTE, ESTE ES EL SIGUIENTE NODO, HAY QUE ENTENDERLO DE FORMA GENERAL, ACA SE ARMA LA RED DE CONEXIONES DE LA LINKEDLIST!
...
struct LinkedList // ESTA ES LA LISTA PROPIAMENTE DICHA, ANTES SE DETALLA EL NODO POR QUE SON ESTRUCTURAS QUE SE CONTIENE UNA ADENTRO DE LA OTRA, COMO LA FECHA!
{
...
//Publicas
LinkedList* ll_newLinkedList(void); // DEVUELVE UN PUNTERO DE TIPO LINKEDLIST!
